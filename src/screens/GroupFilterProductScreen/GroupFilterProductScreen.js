...
import GroupFilterProductTable from "../../components/Table/GroupFilterProductTable/GroupFilterProductTable";
        ...
        <div className="w-full flex">
          ...
          <div className="w-3/5">
            ...
            <Table category={category} feature={feature}>
              <GroupFilterProductTable category={category} feature={feature} />
            </Table>
          </div>
        </div>
      </div>
